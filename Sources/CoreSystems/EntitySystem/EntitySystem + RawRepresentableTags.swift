...
extension EntitySystem {
  ...
  public func does<Raw: RawRepresentable>(entity: Entity, contain tag: Raw) throws -> Bool where Raw.RawValue == String {
  ...
  public func does<Raw: RawRepresentable>(entity: Entity, contain tags: [Raw]) throws -> Bool where Raw.RawValue == String {
