...
extension EntitySystem {
    ...
    public mutating func add(_ tag: Tag, to entity: Entity) throws {
    ...
    public mutating func remove(_ tag: Tag, from entity: Entity) throws {
        guard allEntities.contains(entity) else { throw Error.entityDoesNotExist(entity) }
    ...
    public mutating func removeTagFromAllEntities(_ tag: Tag) {
        entityByTag[tag] = nil
    }
    
    /// Returns wether the entity contains the tag. Throws if the entity doesnt exist.
    public func does(entity: Entity, contain tag: Tag) throws -> Bool {
        guard allEntities.contains(entity) else { throw Error.entityDoesNotExist(entity) }
    ...
    public func does(entity: Entity, contain tags: [Tag]) throws -> Bool {
        guard allEntities.contains(entity) else { throw Error.entityDoesNotExist(entity) }
    ...
    public func getEntities(with tag: Tag) -> Set<Entity> {
    ...
    public func getTags(for entity: Entity) throws -> Set<Tag> {
        guard allEntities.contains(entity) else { throw Error.entityDoesNotExist(entity) }
    ...
    public func getEntities(with tags: [Tag]) -> Set<Entity> {
    ...
    public func getEntities(withAny tags: [Tag]) -> Set<Entity> {
    ...
    public func getEntities(without tags: [Tag]) -> Set<Entity> {
