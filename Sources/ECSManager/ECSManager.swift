...
/*
 The ECSManager is the head of operations for an ECS. It allows for Components and Tags to be safely adhered to to an Entity. It also mantains systems and the current systemTime.
 */
public class ECSManager {
  ...
  internal var entityMasks = Dictionary<Entity, ContainedItems>()
  
  /// Holds all the types of components and manages what entity they are set too.
  internal var componentSystems = Dictionary<ComponentFamilyID, ComponentStorage>()
